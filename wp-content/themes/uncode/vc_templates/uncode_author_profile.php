...
if ( $display_button === 'yes' ) {
	...
	$content_out .= '<span class="' . esc_attr(trim(implode(' ', $btn_wrapper_class))) . '" '.implode(' ', $button_data_attributes).'><a href="' . esc_url($a_href) . '" class="custom-link ' . esc_attr(trim(implode(' ', $btn_classes))) . '"' . $title . $target . $onclick . $rel . $width . '>Todas las entradas del autor</a></span>';
